...
const InterviewEvaluationForm: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      await axiosInstance.post("/api/interview-feedback", { data: formData });
  ...
  return (
    ...
    >
      {showPopup && (
        <div
          onClick={(e) =>
            (e.target as HTMLElement).classList.contains("popup-container") &&
            setShowPopup(false)
          }
        ...
        >
          <div className="relative bg-white rounded-lg p-8 w-11/12 max-w-lg shadow-xl">
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Interview evaluation forms are to be completed by the interviewer
              to rank the candidate’s overall qualifications for the position
              for which they have applied. Use the following scale for your
              evaluation:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              <li>
                <strong>5 – Exceptional:</strong> Outstanding capabilities.
              </li>
              <li>
      ...
      <div className="bg-white w-full max-w-3xl shadow-xl rounded-lg overflow-hidden">
        <div className="p-6 relative">
          ...
          <p className="text-gray-600 mt-2">{descriptions[currentStep]}</p>
